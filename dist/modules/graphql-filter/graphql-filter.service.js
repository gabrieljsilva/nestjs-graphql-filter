...
let GraphqlFilterService = class GraphqlFilterService {
    constructor(graphqlFilterAdapter) {
        this.graphqlFilterAdapter = graphqlFilterAdapter;
    }
    getQuery(filter) {
        return this.graphqlFilterAdapter.getQuery(filter);
    }
};
...
//# sourceMappingURL=graphql-filter.service.js.map